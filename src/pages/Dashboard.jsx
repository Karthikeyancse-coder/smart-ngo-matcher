        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="relative w-full md:w-96 group">
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2 flex gap-1">
              <span className="px-1.5 py-0.5 rounded bg-nx-bg-elevated border border-nx-border-subtle text-[10px] text-nx-text-tertiary font-mono">⌘</span>
              <span className="px-1.5 py-0.5 rounded bg-nx-bg-elevated border border-nx-border-subtle text-[10px] text-nx-text-tertiary font-mono">K</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <Link to="/upload" className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl bg-nx-accent-primary hover:bg-nx-accent-hover text-white transition-all hover:-translate-y-1 shadow-card hover:shadow-glow group">
                <UploadCloud className="w-6 h-6 group-hover:scale-110 transition-transform" />
                <span className="font-semibold text-sm">Upload Survey</span>
              </Link>
              <Link to="/map" className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl bg-nx-bg-surface border border-nx-border-default hover:border-nx-accent-primary text-nx-text-primary transition-all hover:-translate-y-1 shadow-sm group">
                <MapPin className="w-6 h-6 text-nx-cyan group-hover:scale-110 transition-transform" />
                <span className="font-semibold text-sm">Intel Heatmap</span>
              </Link>
              <Link to="/match" className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl bg-nx-bg-surface border border-nx-border-default hover:border-nx-accent-primary text-nx-text-primary transition-all hover:-translate-y-1 shadow-sm group">
                <Users className="w-6 h-6 text-nx-amber group-hover:scale-110 transition-transform" />
                <span className="font-semibold text-sm">Smart Match</span>
              </Link>
            </div>
